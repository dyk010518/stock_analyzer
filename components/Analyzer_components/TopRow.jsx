    ...
    return (
        <thead className="text-white">
            <tr className="bg-white/10">
                ...
                <th className="py-2 text-lg lg:text-xl font-semibold border-b border-white/20 text-primary-300 w-1/3" colSpan={3}>
                    {"Past Numbers"}
                </th>
                <th className="py-2 text-lg lg:text-xl font-semibold border-b border-white/20 text-primary-300" colSpan={3}>
                    <div className="relative flex justify-center items-center">
                        <span>{`${numYears}-Year Assumptions`}</span>
                        <select
                            className="absolute right-4 lg:right-12 xl:right-16 text-sm lg:text-lg bg-gray-800 text-white border border-white/20 rounded-md px-1 lg:px-2 py-1 focus:outline-none focus:ring-2 focus:ring-primary-300 hover:bg-gray-700 transition-all duration-150"
                            value={numYears}
